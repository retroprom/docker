...
docker build build/pdp8-dms -f Dockerfile -t retroprom/simh-kit-pdp8-dms --build-arg SIMULATOR=pdp8 "$@"
docker build build/pdp8-focal -f Dockerfile -t retroprom/simh-kit-pdp8-focal --build-arg SIMULATOR=pdp8 "$@"
docker build build/pdp8-os8 -f Dockerfile -t retroprom/simh-kit-pdp8-os8 --build-arg SIMULATOR=pdp8 "$@"
docker build build/pdp8-tss8 -f Dockerfile -t retroprom/simh-kit-pdp8-tss8 --build-arg SIMULATOR=pdp8 "$@"
